...
class CapitalT(object):
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        self.corner1V = rg.Point(intersection_center.x - width/2, intersection_center.y - letter_thickness/2)
        self.corner2V = rg.Point(intersection_center.x + width/2, intersection_center.y + letter_thickness/2)
        self.corner1H = rg.Point(intersection_center.x - letter_thickness/2, intersection_center.y - letter_thickness/2)
        self.corner2H = rg.Point(intersection_center.x + letter_thickness/2, intersection_center.y + height - letter_thickness/2)

        self.v_rect = rg.Rectangle(self.corner1V, self.corner2V)
        self.h_rect = rg.Rectangle(self.corner1H, self.corner2H)
    ...
    def clone(self):
        ...
        CapitalT2 = CapitalT(self.intersection_center, self.width, self.height, self.letter_thickness)
        CapitalT2.set_colors(self.fill_color, self.outline_color)
        return CapitalT2
